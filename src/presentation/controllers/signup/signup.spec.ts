...
describe('SignUp Controller', () => {
  ...
  test('Should call email that was sent during request', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should return 500 if email validator returns exception', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should call AddAccount if correct request', () => {
  ...
  test('Should return 500 if AddAccount returns exception', () => {
    const { sut, addAccountStub } = makeSut()
  ...
  test('Should return 200 if AddAccount is succesful', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
